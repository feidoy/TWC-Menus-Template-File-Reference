...
class MainPage(Handler):
    ...
    #   if picture_link and service_type and recipe_name and ingredient_list and chef_notes and pack_list and allergens and truck_name and recipe_name:
    #     foodtruck_entity = FoodTruck(picture_link=link, service_type = service_type, truck_name = truck_name, recipe_name = recipe_name, ingredient_list = ingredient_list, chef_notes = chef_notes, pack_list= pack_list, allergens = allergens, video_link = video_link)
    ...
    #     self.redirect('/?error=*** ERROR!! Please be sure to fill out ALL the sections!!! ***')
...
class TruckSelectHandler(Handler):
    def get(self):

      self.render('truck_select.html')
...
app = webapp2.WSGIApplication([
    ...
    ('/truck_select', TruckSelectHandler),
], debug=True)
